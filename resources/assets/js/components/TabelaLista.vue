<template>
  <div>
    ...
    <div class="form-inline">
      ...
      <modallink v-if="criar && modal" v-bind:tipo="tipo" nome="adicionar" titulo="Criar" css=""></modallink>
...
<script>
    export default {
      props:['titulos','itens','ordem','ordemcol','criar','detalhe','editar','deletar','token','modal','tipo'],
      data: function(){
        return {
          buscar:'',
